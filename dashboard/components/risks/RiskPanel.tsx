...
export function RiskPanel({ forceExpanded = false }: RiskPanelProps) {
  ...
  return (
    <div className={`border-t border-gray-800 bg-gray-950 transition-all duration-300 ${forceExpanded ? "h-full" : isOpen ? "h-72" : "h-10"} flex flex-col flex-shrink-0`}>
